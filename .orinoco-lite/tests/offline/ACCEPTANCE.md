...
```console
python3 .orinoco-lite/tests/offline/run_offline_acceptance.py prepare
python3 .orinoco-lite/tests/offline/run_offline_acceptance.py deny
```
...
`sandbox-exec` with `.orinoco-lite/tests/offline/macos-network-deny.sb` and requires a socket
