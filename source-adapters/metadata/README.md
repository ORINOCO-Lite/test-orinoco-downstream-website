...
This site-owned source adapter is the first proof of the Orinoco metadata-adapter goal.
...
This keeps executables and symlinks out of the site-owned `source-adapters/` tree that Orinoco validates and packages.
